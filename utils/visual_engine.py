#!/usr/bin/env python3
"""
HexStrike AI - Visual Engine Module

Modern, beautiful output formatting with animations and colors.
Provides consistent reddish hacker theme across the entire framework.
"""

from typing import Dict, Any
import os

# API Configuration (for banner display)
